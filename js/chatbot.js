...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (!launcher) {
    ...
    launcher.innerHTML = `<svg viewBox="0 0 400 400" xmlns="http://www.w3.org/2000/svg" width="120" height="120" style="display:block; position:absolute; top:-12px; left:-12px;">
<defs>
...
<g>
  ...
  <animateTransform attributeName="transform"
    ...
    launcher.style.width = '96px';
    launcher.style.height = '96px';
